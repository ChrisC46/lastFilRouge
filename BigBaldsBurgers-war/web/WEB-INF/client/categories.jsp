...
<div class="py-3" style="">
    <div class="container-fluid">
        <div class="row col-md-9">
            ...
            <div class="col-md-3" style="">
                <div class="card">
                    <c:url value="FrontControleur?section=EntreeG" var="entree" />
            ...
            <div class="col-md-3" style="">
                <div class="card">
                    <c:url value="FrontControleur?section=BurgerG" var="burgers" />
    ...
    <div class="py-3" style="">
        <div class="container-fluid">
            <div class="row col-md-9">
                <div class="col-md-3" style="">
                    <div class="card">
                        <c:url value="FrontControleur?section=AccompagnementG" var="accompagnements" />
                ...
                <div class="col-md-3" style="">
                    <div class="card">
                        <c:url value="FrontControleur?section=BoissonG" var="boisson" />
                ...
                <div class="col-md-3" style="">
                    <div class="card">
                        <c:url value="FrontControleur?section=DessertG" var="dessert" />
